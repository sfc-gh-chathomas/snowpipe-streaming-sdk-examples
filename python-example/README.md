...
| Elastic 2 | [`elastic_step2_continuous.py`](./elastic_step2_continuous.py) | Append without waiting, pause on SDK backpressure, and flush at shutdown. |
...
without reading another event and retries the same event. It does not track
asynchronous delivery outcomes; step 3 adds acknowledgement Futures.
