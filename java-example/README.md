# Java Streaming Quickstarts

Two self-contained examples send ten rows using SDK 1.8.0: an Elastic channel
quickstart and a named channel quickstart. Requires JDK 11+ and Maven.
...
```bash
mvn compile
mvn exec:java -Dexec.mainClass=com.snowflake.example.ElasticChannelQuickstart
mvn exec:java -Dexec.mainClass=com.snowflake.example.NamedChannelQuickstart
```
